 ...
 */
function atto_hideabox_strings_for_js() {
    global $PAGE;
 ...
 */
function atto_hideabox_params_for_js($elementid, $options, $fpoptions) {
	global $USER, $COURSE;
	//coursecontext
	...
	$params['usercontextid'] = $usercontextid;
		...
		if(!has_capability('atto/hideabox:visible', $coursecontext) ){
			$disabled=true;
		 }
